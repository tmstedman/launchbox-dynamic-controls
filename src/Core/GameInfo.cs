...
/// the primary key when looking up per-game label XML entries; more stable than
/// <see cref="RomName"/> across ROM renames or No-Intro set updates. Null when the game has
/// no database match.</param>
